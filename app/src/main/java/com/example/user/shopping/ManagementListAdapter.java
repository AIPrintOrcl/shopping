...
public class ManagementListAdapter extends BaseAdapter {
    ...
    public ManagementListAdapter(Context context, List<Item> itemList, Fragment parent) {
    ...
    public View getView(final int position, View convertView, final ViewGroup viewGroup) {
        View v = View.inflate(context, R.layout.management, null);
        TextView managementTextView = (TextView) v.findViewById(R.id.managementTextView);
        ...
        final TextView itemUpdateDate = (TextView) v.findViewById(R.id.itemUpdateDate);
        final TextView itemPrice = (TextView) v.findViewById(R.id.itemPrice);
        final TextView itemAmount = (TextView) v.findViewById(R.id.itemAmount);
        ...
        managementTextView.setText("" + (position + 1) + "");
        ...
        ManagementFragment.price.setText(ManagementFragment.totalPrice + " 원");
        ...
        final String list = itemList.get(position).getList();
                                ...
                                AlertDialog dialog = builder.setMessage("물품을 삭제 하시겠습니까?")
                                        ...
                                        .setPositiveButton("삭제", new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int which) {
                                                ManagementFragment.totalPrice -= price * itemList.get(position).getItemAmount(); // 총 가격의 합
                                                ManagementFragment.price.setText(ManagementFragment.totalPrice + " 원");
            ...
            public void onClick(View v) {
                ...
                AlertDialog dialog = builder.setPositiveButton("변경", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        ItemPriceAmountUpdateRequest itemPriceAmountUdateRequest = new ItemPriceAmountUpdateRequest(userID, itemList.get(position).getItemID() + "", itemPrice + "", itemAmount + "", responseListener);
                        RequestQueue queue = Volley.newRequestQueue(parent.getActivity());
                        queue.add(itemPriceAmountUdateRequest);
        ...
        Button itemBuyOrYetButton = (Button) v.findViewById(R.id.itemBuyOrYetButton);
